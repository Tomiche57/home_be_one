...
<!-- Page d'accueil aux utilisateurs non connectés -->
...
<<<<<<< HEAD
			<em><a  href="http://localhost/home_be_one/tests/connexion_gustave.php" id="connexion">Se connecté</a></br></em>
=======
			<em><a  href="http://localhost/home_be_one/tests/connexion_gustave.php" id="connexion">Se connecter</a></br></em>
>>>>>>> 698550bcf8f6adc33ebdf87f07dd0c4bca05552e
		...
		<div id="main">
			...
			<section class="tiles">
				...
				<article>
					<header class="major">
						<h3><a href="#" class="link">Review</h3>
						<p>What users think about us</p>
					</header>
				</article>
				<article>
					<header class="major">
						<h3><a href="#" class="link">Why us and not another</h3>
					</header>
				</article>
			</section>
			...
			<section id="two">
				<div class="inner">
					...
					<p><!--Texte--></p>
					<ul class="actions">
						<li><a href="#" class="button next">Get the Force</li>
					</ul>
				</div>
			</section>
				...
				<div>
					<section>
						<section>
							<div>
								<h3>Address</h3>
								<span>28 Rue Notre Dame des Champs<br />
								Paris, 75006<br />
								France</span>
							</div>
						</section>
...
<form method="post" action="http://www.domisep.com/cible.php">
